    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="add_about.php" class="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 transition">+ Tambah Data</a>
            </div>
            ...
            <div class="space-y-4">
                ...
                while ($data = mysqli_fetch_array($query)) {
                    ...
                    echo "<pre class='mb-3 whitespace-pre-wrap text-gray-800'>" . htmlspecialchars($data['about']) . "</pre>";
