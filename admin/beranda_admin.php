...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4">
            ...
            <li><a href="data_artikel.php" class="block hover:text-blue-600">Kelola_Artikel</a></li>
            <li><a href="data_gallery.php" class="block hover:text-blue-600">Kelola_Gallery</a></li>
...
tbl_gallery"));
        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            <div class="text-lg text-gray-800 mb-4">
                Halo, <strong class="text-blue-700">
