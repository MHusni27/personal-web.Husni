...
<body class="bg-gray-100 text-gray-800 font-sans">
    <!-- Header -->
    <header class="bg-red-900 text-white text-center p-6 text-2xl font-bold">
        Personal Web | Muhammad Husni
    </header>
    <!-- Navigation -->
    ...
    <!-- Main Content -->
    <main class="max-w-6xl mx-auto p-6 grid grid-cols-1 md:grid-cols-3 gap-6mt-6">
        <!-- Artikel Utama -->
